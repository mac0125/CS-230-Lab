        ...
        <div class="container" align="center" style="max-width: 800px">
            <div class="my-auto">
                <form id="review-form" action="includes/review-helper.php" method="post">
                    ...
                    <div class="form-group" sytle="margin-top: 15px"> 
                        ...
                        <textarea name="review" id="review-text" cols="85" rows="3" placeholder="Enter Your Review..."></textarea>

                        <input type="hidden" name="rating" id="rating">
                        <input type="hidden" name="item_id" value="<?php echo $_GET['id'];?>">
                    </div>
                    <div class="form-group">
                        <button class="btn btn-outline-danger" type="submit" name="review-submit" id="review-submit" style="width: 100%">Submit Review</button>
                    </div>
                </form>
            </div>
        </div>
